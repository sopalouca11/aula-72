...
export default class TransactionScreen extends Component {
    ...
    db.collection("books")
      ...
      .then(doc => {
        ...
        if (book.is_book_available) {
          ...
          Alert.alert("livro retornado para a biblioteca");
          ToastAndroid.show("livro retornado para a biblioteca",ToastAndroid.SHORT)
        }
      });
  };
  ...
  initiateBookIssue = async (bookId, studentId, bookName, studentName) => {
    db.collection("transections").add({
      student_id: studentId,
      student_name: studentName,
      book_id: bookId,
      book_name: bookName,
      data: firebase.firestore.Timestamp.now().toDate(),
      transection_type: "issue"
    });
    db.collection("books")
      .doc(bookId)
      .update({
